<template>
  <div
    ...
    style="margin-bottom: 16px; min-height: 60px; background-color: rgba(245, 158, 11, 0.2); border: 3px solid #f59e0b; border-radius: 8px; box-shadow: 0 10px 15px -3px rgba(245, 158, 11, 0.3);"
  >
    <!-- 可折叠头部 -->
    <button
      type="button"
